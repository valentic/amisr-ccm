# AMISR CCM Hub Embedded Data Transport System
...
```bash
git clone --recurse-submodules https://github.com/valentic/amisr-ccm.git
cd amisr-ccm 
```
...
```
make amisr-ccm-v2_defconfig all
```
